...
exports.run = (client, message, args) => {
        weather.find({search: args.join(" "), degreeType: 'F'}, function(err, result) { // Make sure you get that args.join part, since it adds everything after weather.
            ...
            const embed = new Discord.RichEmbed()
                ...
                .setColor(0x36393f) // This sets the color of the embed, you can set this to anything if you look put a hex color picker, just make sure you put 0x infront of the hex
...
exports.help = {
    name: 'weather',
    description: 'Displays the weather with provided location.',
